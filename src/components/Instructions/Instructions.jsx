    ...
    if (mode === "flat") {
      return (
        <div>
          ...
          <p>
            2. 今回の目的が2点の長さ測定であれば長さ測定
            平面を測定したい場合は平面を測定ボタンを押下してください。
          </p>
          <p>3. まず千円札の４つ角を画面の指示に従ってクリックしてください。</p>
          <p>
            4.
            スケールが設定されたら、測りたいオブジェクトの両端をクリックしてください。
            <br />
            (平面測定の場合は指示に従って4点クリック)
          </p>
          <p>5. 計測開始を押すと目的物の長さ（面積）を自動計算します。</p>
          <p style={{ color: "red" }}>
            注意点：測りたい長さのものと同じ高さ（平面上）に千円札を置いてください。
            <br />
            ※置き方や、写真の角度は問題ありませんが、
            <br />
